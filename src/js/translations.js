...
export const translations = {
  nl: {
    ...
    "projects-card-desc": "Bekijk de projecten waar wij aan werken in Tanzania",
    ...
    "blog-water-women-desc":
      "Ontdek hoe ons waterproject het leven van Maasai-vrouwen verandert door water dichterbij te brengen.",
    ...
    // Naserian page specific translations
    ...
    "blog-water-women-title":
      "Water halen: een vrouwenzaak – en waarom dat ertoe doet bij de Maasai",
    "blog-date-july": "14 juli 2025",
    "blog-category-gender": "Waterproject",
    "blog-water-women-intro":
      "Bij de Maasai-gemeenschappen in Tanzania zijn de rollen tussen mannen en vrouwen al generaties lang duidelijk verdeeld. In deze traditioneel georganiseerde samenleving houden mannen zich bezig met het hoeden van vee en het nemen van belangrijke beslissingen binnen de gemeenschap. Vrouwen zijn verantwoordelijk voor het huishouden, de zorg voor de kinderen én – cruciaal – het halen van water.",
    "water-women-caption1":
      "Een Maasai vrouw bereidt zich voor op de dagelijkse tocht om water te halen met behulp van ezels",
    "blog-water-women-paragraph1":
      "Water halen is geen kleine taak. Vrouwen en meisjes leggen vaak kilometerslange tochten af naar de dichtstbijzijnde waterbron. Daarbij maken ze gebruik van ezels om de zware jerrycans met water te vervoeren. Hoewel de ezels het fysieke werk deels verlichten, blijft het een tijdrovende en vermoeiende taak, vaak onder de brandende zon en in onveilige omstandigheden.",
    "blog-water-project-changes-title": "Een waterproject dat levens verandert",
    "blog-water-project-changes-text":
      "Juist daarom is het waterproject dat we samen met de Maasai-gemeenschappen in Loolera en Lembapuli uitvoeren zo belangrijk. Het doel is simpel, maar de impact is groot: door toegang tot veilig en schoon water dichter bij huis te brengen, verandert er veel. Voor de hele gemeenschap – maar in het bijzonder voor vrouwen en meisjes.",
    "water-women-caption2":
      "De gemeenschap komt samen bij het waterpunt - een cruciale plek voor sociale interactie en overleving",
    "blog-water-women-paragraph2":
      "Doordat zij nu niet meer uren hoeven te lopen naar een verre bron, wordt hun dagelijkse last letterlijk verlicht. Het verhoogt hun veiligheid – ze hoeven niet meer door afgelegen gebieden te trekken – en het geeft hen meer tijd voor andere belangrijke activiteiten: school, werk, rust.",
    "blog-from-burden-to-strength-title": "Van last naar kracht",
    "blog-from-burden-to-strength-text1":
      "Dit project doet meer dan alleen water brengen. Het raakt aan diepgewortelde structuren en geeft vrouwen ruimte en kracht om een actievere rol te spelen binnen hun gemeenschap. Het biedt kansen voor meisjes om langer op school te blijven en voor vrouwen om economische activiteiten op te starten.",
    "blog-from-burden-to-strength-text2":
    ...
    "support-water-project-text":
      "Help ons meer waterpunten aan te leggen en geef Maasai-vrouwen hun tijd, veiligheid en waardigheid terug.",
    ...
    "report-more-info": "Meer informatie hierover vind je in ons jaarverslag.",
  ...
  en: {
    ...
    "blog-water-women-desc":
      "Discover how our water project transforms the lives of Maasai women by bringing water closer to home.",
    ...
    // Quote section
    "quote-text":
      "\"Since I've been back in the Netherlands, I'm amazed at how I've taken for granted that I can simply turn on my tap and clean water comes out. It's something I've come to appreciate more through my life in Tanzania.\"",
